...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-s8pw34.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-s8pw34.containers.anotherwebservice.com/
...
```
git clone git@github.com:rotleaf/container-s8pw34.git
cd container-s8pw34
```
...
```
docker attach container-s8pw34
```
